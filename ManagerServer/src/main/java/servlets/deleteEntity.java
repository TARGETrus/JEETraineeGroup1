...
public class deleteEntity extends HttpServlet {
    ...
    private String deleteUser(String entityName) {
        ...
        if (!entityName.equals("")) {
            ...
            User user = manager.getUserData(entityName);
    ...
    private String deleteEvent(String entityName) {
        ...
        if (!entityName.equals("")) {
            ...
            Event event = manager.getEventData(entityName);

            if (event != null) {

                if (manager.deleteEvent(event)) {
    ...
    private String deleteGroup(String entityName) {
        ...
        if (!entityName.equals("")) {
            ...
            Groupp group = manager.getGroupData(entityName);

            if (group != null) {

                if (manager.deleteGroup(group)) {
