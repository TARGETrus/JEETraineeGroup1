 ...
 */
@WebServlet("/xmlAPI/CreateEntity")
public class CreateEntity extends AbstractAutowiringServlet {

    private static final long   serialVersionUID  = 1L;
    private static final String ERROR_MSG         = "Internal Error occupied while creating entity data!";
